...
class XacnhanLichSu2 extends StatefulWidget {
  const XacnhanLichSu2({super.key});

  @override
  State<XacnhanLichSu2> createState() => _XacnhanLichSu2();
}

class _XacnhanLichSu2 extends State<XacnhanLichSu2> {

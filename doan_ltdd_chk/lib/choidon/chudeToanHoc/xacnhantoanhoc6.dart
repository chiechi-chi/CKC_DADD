...
class XacnhanLichSu6 extends StatefulWidget {
  const XacnhanLichSu6({super.key});

  @override
  State<XacnhanLichSu6> createState() => _XacnhanLichSu6();
}

class _XacnhanLichSu6 extends State<XacnhanLichSu6> {

...
class XacnhanLichSu7 extends StatefulWidget {
  const XacnhanLichSu7({super.key});

  @override
  State<XacnhanLichSu7> createState() => _XacnhanLichSu7();
}

class _XacnhanLichSu7 extends State<XacnhanLichSu7> {
